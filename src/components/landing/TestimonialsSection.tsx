      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <button
            type="button"
            onClick={prev}
            className="absolute -left-6 top-1/2 -translate-y-1/2 bg-primary/15 hover:bg-primary/30 text-primary rounded-full h-10 w-10 flex items-center justify-center backdrop-blur-sm transition-colors"
          >
            ‹
          </button>
          <button
            type="button"
            onClick={next}
            className="absolute -right-6 top-1/2 -translate-y-1/2 bg-primary/15 hover:bg-primary/30 text-primary rounded-full h-10 w-10 flex items-center justify-center backdrop-blur-sm transition-colors"
          >
            ›
          </button>
