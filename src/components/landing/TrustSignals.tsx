    ...
    >
      ...
      <div className="flex items-center gap-2 text-center">
        ...
        <p className="text-sm md:text-base text-muted-foreground">
          <span className="font-semibold text-foreground">Trusted by event organizers of all sizes</span> as one of the
          most cost-efficient marketing tools
        </p>
      ...
      {/* Glow Line unten – Abschluss zum nächsten Abschnitt */}
