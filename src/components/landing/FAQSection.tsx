    ...
    <section className="py-28 bg-muted/15 relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-4xl relative z-10">
        ...
        <ScrollReveal animation="fade-up" delay={100} duration={600}>
          <div className="flex flex-wrap justify-center gap-2 md:gap-3 mb-10">
            {categories.map((cat, index) => (
              <ScrollReveal key={cat} animation="fade-up" delay={50 + index * 40} duration={400}>
                <button
                  type="button"
                  onClick={() => {
        ...
        <ScrollReveal animation="fade-up" delay={200} duration={700}>
          <Card className="bg-card/80 backdrop-blur-sm border-border/60 shadow-md shadow-black/20">
