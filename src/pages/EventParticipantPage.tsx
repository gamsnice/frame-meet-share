...
import { Calendar, MapPin, Globe, Instagram, Linkedin, Images } from "lucide-react";
          ...
          <div className="flex flex-col items-center gap-3 sm:gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 md:gap-6 w-full lg:w-auto">
              ...
              <div className="w-full text-center lg:text-left">
                ...
                {event.hero_subtitle && (
                  <p className="text-xs sm:text-sm md:text-base lg:text-lg opacity-90 max-w-2xl mx-auto lg:mx-0 line-clamp-2 sm:line-clamp-none mb-2 sm:mb-3">
                    {event.hero_subtitle}
                  </p>
                )}
